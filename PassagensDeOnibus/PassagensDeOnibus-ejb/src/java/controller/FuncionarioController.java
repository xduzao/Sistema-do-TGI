...
public class FuncionarioController implements InterfaceController, Controller {
    ...
    public void salvaObjeto(Object obj) {
        ...
        @Override
    public List<FuncionarioTO> exibeLista() {

       return transfereVOPraTO(container.getListaDeFuncionario());
    }
